...
from data_preparation.v2.diffusion.constant_names_variables import str_area_id_presenze, str_time_block_id_presenze, str_visitor_class_id_presenze, str_country_presenze, col_str_is_week
from data_preparation.v2.diffusion.constant_names_variables import AGGREGATION_NAMES_2_COLUMNS_AGGREGATION_PRESENCES, DICT_NAME_OUTPUT_KEY_2_DEFAULT_INIT_PIPELINE_3
