...
from data_preparation.v2.diffusion.GeometrySphere import choose_closest_point
...
def concat_df_od_and_add_columns(list_files_od, s3, str_period_id_presenze, col_str_day_od, col_str_is_week):
    ...
    """
    from data_preparation.v2.diffusion.VodafoneData import extract_od_vodafone_from_bucket, add_column_is_week_and_str_day
    from tqdm import tqdm
