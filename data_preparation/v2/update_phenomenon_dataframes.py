...
The updating procedure shall include a STANDARDIZATION PART (to make the new phenomena compatible with the old ones) and an UPDATE PART (taking into account data overlaps, 
which are for choice updated to the newest ones)
"""
...
def standardize_upd_strutture_2024(mapping_comuni):
    """Adapts the structure to the "standard" one in order to reuse standardize_strutture()"""
